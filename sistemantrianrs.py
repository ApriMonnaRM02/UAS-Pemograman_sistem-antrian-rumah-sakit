...
class ManajemenAntrian:
    ...
    def _hitung_waktu_tunggu(self, pasien):
        ...
        waktu = waktu_pelayanan * (jumlah_antrian // max(dokter_tersedia, 1) + 1)
        
        pasien.waktu_tunggu = waktu
        pasien.rekam_medis.tambah_status(StatusPasien.MENUNGGU, f"Waktu tunggu: {waktu}")
    ...
    def panggil_pasien_berikutnya(self):
        ...
        if dokter_cocok:
            ...
            print(f"Keadaan: {pasien.kondisi}")
            print(f"Dokter: {dokter_cocok.nama}")
            print(f"Waktu Tunggu: {pasien.waktu_tunggu}")
    ...
    def tampilkan_antrian(self):
        ...
        print("No | Nama | Poli | Keadaan | Waktu Tunggu")
        print("-" * 55)
        
        for pasien in antrian_sementara:
            print(f"{pasien.nomor_antrian:2d} | {pasien.nama:10s} | {pasien.jenis_poli:5s} | {pasien.kondisi:7s} | {pasien.waktu_tunggu}")
...
def main():
    ...
    while True:
        ...
        if pilihan == '1':
            ...
            for key, value in keadaan_map.items():
                print(f"{key}. {value.capitalize()}")
            keadaan_pilih = input("Masukkan nomor keadaan: ")
            keadaan = keadaan_map.get(keadaan_pilih, 'ringan')
            ...
            pasien_baru = Pasien(nama, umur, keadaan, jenis_poli)
            ...
            if len(antrian.antrian) > 0:
                ...
                catatan = input("Masukkan resep obat (opsional): ")
